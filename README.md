...
It's weird that the deviance explained is high for 'WT Light Search', 'WT Dark Chase' etc. Maybe there are too many '0' events in the training datasets for those groups. Without going to check this hypothesis, I make another prediction here: the testing deviance of these groups are worse than 'WT Light Chase', 'WT Dark Search' etc.
